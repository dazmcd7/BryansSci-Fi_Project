...
public class IdleState:State
{
    ...
    {
		myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 50, -600));
        myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(-600, 0, 0));
		myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, -50, 600));
        myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(650, 0, -600));
